...
public class BasicCardTransformController : MonoBehaviour
{
    // 카드 Translate
    ...
    public Vector3 outBounceScale = new Vector3(0.95f,0.7f,1f);
    ...
    public IEnumerator Animate(Vector2 targetPosition, Vector3 targetScale, float targetRotationZ, float duration)
    {
        ...
        // 최종 결과
        this.rectTransform.anchoredPosition = targetPosition;
        this.rectTransform.localScale = targetScale;
        this.rectTransform.localRotation = Quaternion.Euler(0f,0f,targetRotationZ);
    }
